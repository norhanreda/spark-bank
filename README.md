...
<li><a href="#screen-shots">ScreenShots </a></li>
 <li><a href="#Video">Video</a></li>
  <li><a href="#Website">Website link</a></li>
...
<ul dir="auto">
<li>sparks bank App is a simple web application built using Vue js, HTML , CSS  and firebase data base using fetch to get or post data</li>
</ul>
...
<p dir="auto">This system is designed to show the transactions between customers

and the history of each customer stored in data base.</p>
...
![image](https://user-images.githubusercontent.com/88630231/190918398-45a3e06a-45e0-4fdc-a974-591e1fb2d61f.png)

![image](https://user-images.githubusercontent.com/88630231/190918426-6d0ad36a-7091-4819-a938-08949f45c120.png)

![image](https://user-images.githubusercontent.com/88630231/190918024-ec3d4786-20eb-4b23-8675-69fb443cd337.png)

![image](https://user-images.githubusercontent.com/88630231/190918478-17ab05fe-23d5-491b-926f-cd567fcfa55a.png)
...
<a href="https://youtu.be/AYayut_57lY" target="_blank">Video link:https://youtu.be/AYayut_57lY </a>

<h2 dir="auto"><a id="user-content-Website" class="anchor" aria-hidden="true" href="#Video"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M7.775 3.275a.75.75 0 001.06 1.06l1.25-1.25a2 2 0 112.83 2.83l-2.5 2.5a2 2 0 01-2.83 0 .75.75 0 00-1.06 1.06 3.5 3.5 0 004.95 0l2.5-2.5a3.5 3.5 0 00-4.95-4.95l-1.25 1.25zm-4.69 9.64a2 2 0 010-2.83l2.5-2.5a2 2 0 012.83 0 .75.75 0 001.06-1.06 3.5 3.5 0 00-4.95 0l-2.5 2.5a3.5 3.5 0 004.95 4.95l1.25-1.25a.75.75 0 00-1.06-1.06l-1.25 1.25a2 2 0 01-2.83 0z"></path></svg></a>Website<a name="user-content-Website"></a></h2>


<a href=" https://sparks-bank-cdcdf.web.app" target="_blank">website link: https://sparks-bank-cdcdf.web.app </a>
